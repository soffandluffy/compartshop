    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-dark">Order list</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
                        ...
                        @foreach ($orders as $order)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p class="text-bold">{{ $order->shipping_price }}</p>
                                </td>
                                <td>
                                    <p>{{ $order->address }} ({{ $order->phonenumber }})</p>
                                    <p class="text-muted">({{ $order->message }})</p>
                                </td>
                                <td>
                                    {{ $order->no_resi }}
                                </td>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        @if ($order->status_order == "Order Confirmed")
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#inputResi{{ $order->id }}">Input Resi</a>
                                            </div>
                                            <!--end::Menu item-->
                                        @endif
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $order->id }}">Delete</a>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
                                </td>
...
<div class="modal fade" id="deleteModal{{ $order->id }}" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" action="{{ route('order.delete', $order->id) }}" method="POST">
                <!--begin::Modal header-->
                        ...
                        <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-9 p-6">
                            ...
                            <div class="d-flex flex-stack flex-grow-1">
                                ...
                                <div class="fw-bold">
                                    ...
                                    <div class="fs-6 text-gray-700">Are you sure you want to delete this order?</div>
                                </div>
                                <!--end::Content-->
                            </div>
                            <!--end::Wrapper-->
...
<!--begin::Modal - Input Resi-->
<div class="modal fade" id="inputResi{{ $order->id }}" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <!--begin::Modal content-->
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" action="{{ route('order.inputResi', $order->id) }}" method="POST">
                @csrf
                <!--begin::Modal header-->
                <div class="modal-header">
                    <!--begin::Modal title-->
                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
                        <div class="mb-4 col-lg-12">
                            ...
                            <input type="text" name="no_resi" class="form-control form-control-solid" placeholder="Resi Number"/>
